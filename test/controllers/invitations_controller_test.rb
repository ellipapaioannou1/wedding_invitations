...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { name: @invitation.name, persons_count: @invitation.persons_count } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { name: @invitation.name, persons_count: @invitation.persons_count } }
